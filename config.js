...
const CONFIG = {
  ...
  ui: {
    ...
    text: {
      ...
      pageSubtitle: "Introducing our new and improved wallpaper calculator!<br>Enter wall dimensions to generate a visualization of any of our patterns installed as well as an estimate of how much you'll need to purchase.<br>Submit results if you'd like to receive a quote.<br>We'll be in touch within one business day. (probably sooner)",
